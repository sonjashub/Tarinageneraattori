function generoiTarina() {
    ...
    let tarina = "Olipa kerran " + adjektiivi1 + " lapsonen nimeltä "  +  nimi + ". Hän asui kaupungissa nimeltä " + kaupunki + ", joka oli hyvin " + adjektiivi2 + ", seuranaan " + sukulainen1 + " ja " + sukulainen2 + ". Eräänä " + adjektiivi4 + " iltana " + nimi + " meni " + tilaisuus + " seuranaan " + sukulainen1 + " ja " + sukulainen2 + ". Kotimatkalla heidän kimppuunsa hyökättiin. Hyökkääjällä oli aseenaan " + substantiivi + ". " + sukulainen1 + " ja " + sukulainen2 + " menehtyivät ja heidän viimeiset sanansa olivat " + iskulause1 + "! " + nimi + " selviytyi ja lupasi kunnioittaa sukulaistensa muistoa osallsitumalla " + tekeminen + " turnaukseen joka vuosi. Hän loppuelmänsä oli " + adjektiivi3 + " ja pitkä. " + iskulause2 + "! Sen pituinen se. (Tämä oli Batmanin origin story).";
